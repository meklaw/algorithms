...
class TestOrderedList(unittest.TestCase):
    ...
    def test_add_after_node(self):
        ...
        node2 = Node(15)
        node3 = Node(10)
        # _OrderedList_add_after_node
        list._OrderedList__add_after_node(None, node1)
        self.assertEqual(list.head.next.value, 5)
        self.assertEqual(list.tail.prev.value, 5)
        list._OrderedList__add_after_node(node1, node2)
        self.assertEqual(list.head.next.value, 5)
        ...
        list._OrderedList__add_after_node(node1, node3)
        self.assertEqual(list.head.next.value, 5)
        self.assertEqual(list.head.next.next.value, 10)
        self.assertEqual(list.head.next.next.next.value, 15)
        self.assertEqual(list.tail.prev.prev.prev.value, 5)
        self.assertEqual(list.tail.prev.prev.value, 10)
        self.assertEqual(list.tail.prev.value, 15)
        list._OrderedList__add_after_node(node2, Node(20))
        self.assertEqual(list.head.next.value, 5)
        self.assertEqual(list.head.next.next.value, 10)
        self.assertEqual(list.head.next.next.next.value, 15)
        self.assertEqual(list.head.next.next.next.next.value, 20)
    ...
    def test_add_before_node(self):
        ...
        node3 = Node(10)
        # _OrderedList_add_after_node
        list._OrderedList__add_before_node(None, node1)
        self.assertEqual(list.head.next.value, 5)
        self.assertEqual(list.tail.prev.value, 5)
        ...
        self.assertEqual(list.tail.prev.prev.prev.value, 15)
        self.assertEqual(list.tail.prev.prev.value, 10)
        self.assertEqual(list.tail.prev.value, 5)
        ...
        self.assertEqual(list.tail.prev.prev.prev.prev.value, 20)
        self.assertEqual(list.tail.prev.prev.prev.value, 15)
        self.assertEqual(list.tail.prev.prev.value, 10)
        self.assertEqual(list.tail.prev.value, 5)
    ...
    def test_add(self):
        ...
        self.assertEqual(list.tail.prev.prev.prev.value, 10)
        self.assertEqual(list.tail.prev.prev.value, 10)
        self.assertEqual(list.tail.prev.value, 25)
        ...
        self.assertEqual(list.head.next.next.next.value, 10)
        self.assertEqual(list.head.next.next.next.next.value, 20)
        self.assertEqual(list.head.next.next.next.next.next.value, 25)
        self.assertEqual(list.tail.prev.prev.prev.prev.prev.value, 5)
        self.assertEqual(list.tail.prev.prev.prev.prev.value, 10)
        self.assertEqual(list.tail.prev.prev.prev.value, 10)
        ...
        self.assertEqual(list.len(), 3)
        list.add(25)
        self.assertEqual(list.head.next.value, 25)
        self.assertEqual(list.head.next.next.value, 10)
        self.assertEqual(list.head.next.next.next.value, 10)
        self.assertEqual(list.head.next.next.next.next.value, 5)
        ...
        self.assertEqual(list.head.next.next.next.value, 10)
        self.assertEqual(list.head.next.next.next.next.value, 10)
        self.assertEqual(list.head.next.next.next.next.next.value, 5)
        self.assertEqual(list.tail.prev.prev.prev.prev.prev.value, 25)
        self.assertEqual(list.tail.prev.prev.prev.prev.value, 20)
        self.assertEqual(list.tail.prev.prev.prev.value, 10)
        self.assertEqual(list.tail.prev.prev.value, 10)
        self.assertEqual(list.tail.prev.value, 5)
